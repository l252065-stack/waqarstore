    ...
    <div className="w-full max-w-sm">
      <div className="bg-white p-8 shadow-sm border border-gray-100">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 border border-gray-200 py-2.5 px-4 text-sm font-medium text-[#0a0a0a] hover:bg-[#f5f4f2] transition-colors disabled:opacity-50"
        >
          {/* Google SVG */}
